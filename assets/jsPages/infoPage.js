...
function renderInfoPage(){
    ...
    // Sektion - Rockbjörnen
    const rockBjornen = createListSection("rockbjornen", "Rockbjörnen", [
    ...
    const ovrigt = createListSection("ovrigt", "Övriga regler", [
    ...
    // Lägg till text i howToInfoPage
    howToInfoPage.appendChild(infoPageText);

    // ==== Lägg till alla delar i main ====
    main.appendChild(goBackArrow); // Lägg till go-back-arrow först
    main.appendChild(howToInfoPage); // Lägg till how-to-info-page under
