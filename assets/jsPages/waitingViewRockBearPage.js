"use strict";
export {renderWaitingViewRockBearPage}
//this funcition must take the current guessing players points and name as parameters
//returns nothing
function renderWaitingViewRockBearPage(name, points) {
    ...
    main.id = "waitingViewRockBearPage-main";
    ...
    progressText.innerHTML = `<p>${points}p</p>`;
    ...
    main.appendChild(waitingViewRockBearPageText);
